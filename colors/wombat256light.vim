...
let s:wombat.background=['#ffffd7', 230]
let s:wombat.altbackground=['#e3e0d7', 253]
let s:wombat.altbackground2=['#eadead', 187]
let s:wombat.dimforeground=['#999999', 247]
let s:wombat.cursorbg=['#ffffff', 231]
let s:wombat.highlight=['#c3c6ca', 251]
let s:wombat.highlight2=['#554d4b', 239]
let s:wombat.blue=['#0a448e', 24]
let s:wombat.yellow=['#5d7718', 64]
let s:wombat.red=['#721d14', 52]
let s:wombat.green=['#396b11', 58]
